...
//   ./symbolic_down_proj_residual_rmsnorm --force-nonsym         – re-run non-symbolic search even if results exist
//   ./symbolic_down_proj_residual_rmsnorm --force-sym            – re-run symbolic search even if results exist
//   ./symbolic_down_proj_residual_rmsnorm --force-nonsym --force-sym  – re-run both
//
// Output files:
...
int main(int argc, char **argv) {
  ...
  std::vector<DownProjConfig> configs =
      debug ? std::vector<DownProjConfig>{kDebugConfig} : get_configs();
