...
//   ./symbolic_qk_norm_attention --force-nonsym         – re-run non-symbolic
//   search
//   ./symbolic_qk_norm_attention --force-sym            – re-run symbolic
//   search
//   ./symbolic_qk_norm_attention --skip-nonsym          – skip non-symbolic
//   search
//   ./symbolic_qk_norm_attention --skip-sym             – skip symbolic search
//   ./symbolic_qk_norm_attention --config <b,h,q,kv,hd> – single config
//   ./symbolic_qk_norm_attention --sym-checkpoint <f>   – override symbolic
//   checkpoint
//   ./symbolic_qk_norm_attention --time-limit <sec>     – search time limit
//   (default 3600)
//
// Output files:
//   checkpoints/qk_norm_attention/  – per-config and shared symbolic
//   checkpoints results_qk_norm_attention.json  – best times per config
