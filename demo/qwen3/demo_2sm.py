...
if __name__ == "__main__":
    ...
    parser.add_argument("--num-workers", type=int, default=None, help="Number of workers in a persistent kernel")
    parser.add_argument("--num-schedulers", type=int, default=None, help="Number of schedulers in a persistent kernel")
    ...
    if args.use_mirage:
        ...
        if args.num_workers is not None or args.num_schedulers is not None:
        ...
        mpk.embed_layer(
            ...
            weight=w, 
            output=y, 
            grid_dim=(1, total_tokens_per_iter, 1), 
            # grid_dim=(1, 1, 1), 
            block_dim=(128, 1, 1),
