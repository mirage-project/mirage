...
if __name__ == "__main__":
    ...
    if args.use_mirage:
        ...
        if args.profiling:
            ...
            kernel = mirage.PersistentKernel(file_path="/home/ubuntu/mirage_cpp/debug_build/test.cu", mpi_rank=rank, num_workers=92, num_local_schedulers=16, num_remote_schedulers=0, use_nvshmem=True, input_tensors=[item[1] for item in input_tensors], meta_tensors=[step], profiler_tensor=profiler_tensor)
        else:
            kernel = mirage.PersistentKernel(file_path="/home/ubuntu/mirage_cpp/debug_build/test.cu", mpi_rank=rank, num_workers=92, num_local_schedulers=16, num_remote_schedulers=0, use_nvshmem=True, input_tensors=[item[1] for item in input_tensors], meta_tensors=[step], profiler_tensor=None)
