...
public:
  ...
  int register_moe_fp8_sm100_task(threadblock::Graph const &bgraph,
                                  std::vector<int> const &params,
                                  bool w13_linear);
  int register_moe_fp8_blockscale_sm100_task(threadblock::Graph const &bgraph,
                                             std::vector<int> const &params,
                                             bool w13_linear);
  ...
  int register_moe_silu_mul_quantize_fp8_sm100_task(
      threadblock::Graph const &bgraph, std::vector<int> const &params);
  int register_rmsnorm_quantize_fp8_sm100_task(threadblock::Graph const &bgraph,
                                               std::vector<int> const &params);
  ...
  int register_linear_fp8_sm100_task(threadblock::Graph const &bgraph,
                                     std::vector<int> const &params,
                                     bool with_residual);
  int register_linear_fp8_blockscale_sm100_task(
      threadblock::Graph const &bgraph,
      std::vector<int> const &params,
      bool with_residual);
  ...
  int register_gdn_conv1d_sm100_task(threadblock::Graph const &bgraph,
                                     std::vector<int> const &params);
  // Gated-DeltaNet recurrence + fused gated norm (id 237).
  int register_gdn_recurrent_sm100_task(threadblock::Graph const &bgraph,
                                        std::vector<int> const &params);
