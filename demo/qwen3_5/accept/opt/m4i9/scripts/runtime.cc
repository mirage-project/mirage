        ...
        for (bid.z = 0; bid.z < bgraph.grid_dim.z; bid.z++) {
          for (int subtask_id = 0; subtask_id < num_subtasks; subtask_id++) {
            ...
            if (task_type == TASK_MOE_W13_LINEAR_SM100 ||
                ...
                task_type == TASK_MOE_W13_FP8_BLOCKSCALE_SM100 ||
                task_type == TASK_MOE_W2_FP8_BLOCKSCALE_SM100) {
...
TaskGraphResult print_task_graph(
  ...
  task_type_to_name[TASK_DFLASH_ATTENTION_SM100] =
  ...
  task_type_to_name[TASK_MOE_W13_FP8_BLOCKSCALE_SM100] =
      "TASK_MOE_W13_FP8_BLOCKSCALE_SM100";
  task_type_to_name[TASK_MOE_W2_FP8_BLOCKSCALE_SM100] =
      "TASK_MOE_W2_FP8_BLOCKSCALE_SM100";
  task_type_to_name[TASK_MOE_SILU_MUL_QUANTIZE_FP8_SM100] =
      "TASK_MOE_SILU_MUL_QUANTIZE_FP8_SM100";
  task_type_to_name[TASK_RMS_NORM_QUANTIZE_FP8_SM100] =
      "TASK_RMS_NORM_QUANTIZE_FP8_SM100";
