#!/usr/bin/env bash
# M4-I9: isolated clone at origin/qwen3-5_support HEAD (8ff7be39) with its OWN
# freshly-built C++ extension (STALE-EXTENSION TRAP). Pattern from setup_m4i8.sh.
set -uo pipefail
B=$HOME/mpk-qwen35
SRC=$B/mirage
D=$B/mirage-m4i9
...
M=$B/m4i9
PIN=${PIN:-8ff7be39d0d29db10bbf8bf491abd38b169be372}
...
git -C "$D" checkout --quiet -B m4i9 "$PIN" || { echo "CHECKOUT FAILED"; exit 2; }
