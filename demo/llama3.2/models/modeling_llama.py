...
class LlamaDecoderLayer(nn.Module):
    def __init__(
        ...
        self.self_attn = LlamaAttention(config, kv_cache, layer_idx, world_size)
...
class LlamaModel(LlamaPreTrainedModel):
    def __init__(self, config: LlamaConfig, world_size: int):
        ...
        self.layers = nn.ModuleList(
            [
                LlamaDecoderLayer(config, self.kv_cache, layer_idx, world_size)
