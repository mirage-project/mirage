...
void launch_linear_fp8_1d2d_sm100(void *input_ptr,
                             void *weight_ptr,
                             void *output_ptr,
...
void linear_fp8_1d2d_sm100_kernel(torch::Tensor input,
                                torch::Tensor weight,
  ...
  launch_linear_fp8_1d2d_sm100<bfloat16, BATCH_SIZE, OUTPUT_SIZE, REDUCTION_SIZE>(
