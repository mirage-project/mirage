...
for reduction_size in reduction_sizes:
    for output_size in output_sizes:
        ...
        if not has_residual:
            residual = None
        runtime_kernel_blackwell.linear_fp8_1d2d_sm100(x, w, residual, output) # with residual and swapAB
        ...
        # Warm-up
        for _ in range(16):
            runtime_kernel_blackwell.linear_fp8_1d2d_sm100(x, w, residual, output)
