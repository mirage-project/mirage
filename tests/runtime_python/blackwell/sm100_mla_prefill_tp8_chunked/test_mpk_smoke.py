"""MPK end-to-end smoke for mla_prefill_tp8_chunked_layer.

Builds a minimal persistent kernel with only the chunked layer, runs
mpk.compile() + run_test_mode(), and checks the output against PyTorch.
"""
import math
import os
import sys
