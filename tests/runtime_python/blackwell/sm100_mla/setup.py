...
setup(
    ...
    ext_modules=[
        CUDAExtension(
            ...
            depends=[
                os.path.join(this_dir, '../../../../include/mirage/persistent_kernel/tasks/blackwell/mla_sm100_2sm.cuh'),
                os.path.join(this_dir, '../../../../include/mirage/persistent_kernel/tasks/ampere/mma.cuh'),
                os.path.join(this_dir, '../../../../include/mirage/persistent_kernel/tasks/ampere/smem_layout.cuh'),
                os.path.join(this_dir, '../../../../include/mirage/persistent_kernel/tasks/common/common_header.cuh'),
