...
setup(
    ...
    ext_modules=[
        CUDAExtension(
            ...
            depends=[
                os.path.join(this_dir, '../../../../include/mirage/persistent_kernel/tasks/blackwell/mixed_attention_sm100.cuh'),
                os.path.join(this_dir, '../../../../include/mirage/persistent_kernel/tasks/blackwell/attention/decode_attention_sm100.cuh'),
                os.path.join(this_dir, '../../../../include/mirage/persistent_kernel/tasks/blackwell/attention/prefill_attention_sm100.cuh'),
