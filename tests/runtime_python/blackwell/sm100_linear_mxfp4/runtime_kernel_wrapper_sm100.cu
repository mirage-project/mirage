...
std::vector<torch::Tensor> launch_quantize_mxfp4_sm100(torch::Tensor const &input,
  ...
  TORCH_CHECK(err == cudaSuccess,
              "quantize_mxfp4_sm100 launch failed: ", cudaGetErrorString(err));
...
std::vector<torch::Tensor> dispatch_quantize_mxfp4_sm100(torch::Tensor const &input,
  ...
  switch (hidden_size) {
    ...
    case 8192:  return launch_quantize_mxfp4_sm100<8192>(input, mma_n);
    case 16384: return launch_quantize_mxfp4_sm100<16384>(input, mma_n);
    default:
      TORCH_CHECK(false,
          "quantize_mxfp4_sm100 supports K in {256,512,1024,2048,4096,7168,8192,16384}; got ",
          hidden_size);
  }
}
...
void launch_linear_mxfp4_1d2d_sm100_config(void *input_ptr,
  ...
  TORCH_CHECK(batch_size % BLOCK_N == 0,
              "MXFP4 1d2d requires batch_size divisible by BLOCK_N=", BLOCK_N);
  TORCH_CHECK(output_size % BLOCK_M == 0,
              "MXFP4 1d2d requires output_size divisible by BLOCK_M=", BLOCK_M);
  ...
  auto kernel_ptr =
      kernel::linear_mxfp4_1d2d_sm100_kernel<
          /*BATCH_SIZE=*/0, /*OUTPUT_SIZE=*/0,
          REDUCTION_SIZE, BLOCK_M, BLOCK_N, BLOCK_K, NUM_STAGES,
          /*C_N_MAJOR=*/false, EPI_BATCH_LA>;
  ...
  kernel_ptr<<<grid_dim, block_dim, smem_bytes, stream>>>(
      ...
      reinterpret_cast<const type::bfloat16_t *>(residual_ptr),
      output_size, batch_size);
  CUTE_CHECK_ERROR(cudaGetLastError());
}

void launch_linear_mxfp4_1d2d_sm100(void *input_ptr, void *input_sf_ptr,
  ...
  switch (reduction_size) {
    case 256:   return launch_linear_mxfp4_1d2d_sm100_config<256,   128, 128, 256, 6>(
        input_ptr, input_sf_ptr, weight_ptr, weight_sf_ptr, output_ptr, residual_ptr,
        batch_size, output_size);
    case 512:   return launch_linear_mxfp4_1d2d_sm100_config<512,   128, 128, 256, 6>(
        input_ptr, input_sf_ptr, weight_ptr, weight_sf_ptr, output_ptr, residual_ptr,
        batch_size, output_size);
    case 1024:  return launch_linear_mxfp4_1d2d_sm100_config<1024,  128, 128, 256, 6>(
        input_ptr, input_sf_ptr, weight_ptr, weight_sf_ptr, output_ptr, residual_ptr,
        batch_size, output_size);
    case 2048:  return launch_linear_mxfp4_1d2d_sm100_config<2048,  128, 128, 256, 6>(
        input_ptr, input_sf_ptr, weight_ptr, weight_sf_ptr, output_ptr, residual_ptr,
        batch_size, output_size);
    case 4096:  return launch_linear_mxfp4_1d2d_sm100_config<4096,  128, 128, 256, 6>(
        input_ptr, input_sf_ptr, weight_ptr, weight_sf_ptr, output_ptr, residual_ptr,
        batch_size, output_size);
    case 7168:  return launch_linear_mxfp4_1d2d_sm100_config<7168,  128, 128, 256, 6>(
        input_ptr, input_sf_ptr, weight_ptr, weight_sf_ptr, output_ptr, residual_ptr,
        batch_size, output_size);
    case 8192:  return launch_linear_mxfp4_1d2d_sm100_config<8192,  128, 128, 256, 6>(
        input_ptr, input_sf_ptr, weight_ptr, weight_sf_ptr, output_ptr, residual_ptr,
        batch_size, output_size);
    case 16384: return launch_linear_mxfp4_1d2d_sm100_config<16384, 128, 128, 256, 6>(
        input_ptr, input_sf_ptr, weight_ptr, weight_sf_ptr, output_ptr, residual_ptr,
        batch_size, output_size);
    default:
      TORCH_CHECK(false, "linear_mxfp4_1d2d_sm100: unsupported K=", reduction_size);
  }
}
...
template <int REDUCTION_SIZE,
          ...
          int NUM_STAGES, int SUPERGROUP_SIZE,
          int EPI_TILE_N, int EPI_NUM_D_TILES,
          bool EPI_BATCHED, int EPI_BATCH_LA, bool OVERLAP_OUTPUT_MBAR>
void launch_linear_mxfp4_1d2d_2sm_sm100_config(void *input_ptr, void *input_sf_ptr,
                                               void *weight_ptr, void *weight_sf_ptr,
                                               void *output_ptr, void *residual_ptr,
                                               int batch_size, int output_size) {
  TORCH_CHECK(batch_size % BLOCK_N == 0,
              "MXFP4 2SM 1d2d requires batch_size divisible by BLOCK_N=", BLOCK_N);
  ...
  auto kernel_ptr_nobias =
      kernel::linear_mxfp4_1d2d_2sm_sm100_kernel<REDUCTION_SIZE,
          BLOCK_M, BLOCK_N, BLOCK_K, NUM_STAGES, SUPERGROUP_SIZE,
          EPI_TILE_N, EPI_NUM_D_TILES, EPI_BATCHED, EPI_BATCH_LA,
          OVERLAP_OUTPUT_MBAR, /*HAS_BIAS=*/false>;
  auto kernel_ptr_bias =
      kernel::linear_mxfp4_1d2d_2sm_sm100_kernel<REDUCTION_SIZE,
          BLOCK_M, BLOCK_N, BLOCK_K, NUM_STAGES, SUPERGROUP_SIZE,
          EPI_TILE_N, EPI_NUM_D_TILES, EPI_BATCHED, EPI_BATCH_LA,
          OVERLAP_OUTPUT_MBAR, /*HAS_BIAS=*/true>;
  if constexpr (smem_bytes > 48 * 1024) {
    CUTE_CHECK_ERROR(cudaFuncSetAttribute(
  ...
  cutlass::Status status = cutlass::launch_kernel_on_cluster(
      ...
      A_tmap, B_tmap, C_tmap, SFA_tmap, SFB_tmap,
      static_cast<const type::bfloat16_t *>(residual_ptr),
      output_size, batch_size);
  CUTE_CHECK_ERROR(cudaGetLastError());
  TORCH_CHECK(status == cutlass::Status::kSuccess,
              "MXFP4 2SM 1d2d cluster launch failed: ", cutlassGetStatusString(status));
}

void launch_linear_mxfp4_1d2d_2sm_sm100(void *input_ptr, void *input_sf_ptr,
                                        void *weight_ptr, void *weight_sf_ptr,
                                        void *output_ptr, void *residual_ptr,
                                        int batch_size, int output_size,
                                        int reduction_size,
  ...
  switch (reduction_size) {
    case 256:   return launch_linear_mxfp4_1d2d_2sm_sm100_config<256,   128, 256, 256, 4, 4, 64, 2, false, 1, true>(
        input_ptr, input_sf_ptr, weight_ptr, weight_sf_ptr, output_ptr, residual_ptr,
        batch_size, output_size);
    case 512:   return launch_linear_mxfp4_1d2d_2sm_sm100_config<512,   128, 256, 256, 4, 4, 64, 2, false, 1, true>(
        input_ptr, input_sf_ptr, weight_ptr, weight_sf_ptr, output_ptr, residual_ptr,
        batch_size, output_size);
    case 1024:  return launch_linear_mxfp4_1d2d_2sm_sm100_config<1024,  128, 256, 256, 4, 4, 64, 2, false, 1, true>(
        input_ptr, input_sf_ptr, weight_ptr, weight_sf_ptr, output_ptr, residual_ptr,
        batch_size, output_size);
    case 2048:  return launch_linear_mxfp4_1d2d_2sm_sm100_config<2048,  128, 256, 256, 4, 4, 64, 2, false, 1, true>(
        input_ptr, input_sf_ptr, weight_ptr, weight_sf_ptr, output_ptr, residual_ptr,
        batch_size, output_size);
    case 4096:  return launch_linear_mxfp4_1d2d_2sm_sm100_config<4096,  128, 256, 256, 5, 4, 64, 2, false, 1, true>(
        input_ptr, input_sf_ptr, weight_ptr, weight_sf_ptr, output_ptr, residual_ptr,
        batch_size, output_size);
    case 7168:  return launch_linear_mxfp4_1d2d_2sm_sm100_config<7168,  128, 256, 256, 5, 4, 64, 2, false, 1, true>(
        input_ptr, input_sf_ptr, weight_ptr, weight_sf_ptr, output_ptr, residual_ptr,
        batch_size, output_size);
    case 8192:  return launch_linear_mxfp4_1d2d_2sm_sm100_config<8192,  128, 256, 256, 5, 4, 64, 2, false, 1, true>(
        input_ptr, input_sf_ptr, weight_ptr, weight_sf_ptr, output_ptr, residual_ptr,
        batch_size, output_size);
    case 16384: return launch_linear_mxfp4_1d2d_2sm_sm100_config<16384, 128, 256, 256, 5, 4, 64, 2, false, 1, true>(
        input_ptr, input_sf_ptr, weight_ptr, weight_sf_ptr, output_ptr, residual_ptr,
        batch_size, output_size);
    default:
      TORCH_CHECK(false, "linear_mxfp4_1d2d_2sm_sm100: unsupported K=", reduction_size);
  }
}
...
torch::Tensor linear_mxfp4_sm100_no_quantization_kernel(torch::Tensor input,
...
torch::Tensor linear_mxfp4_sm100_kernel(torch::Tensor input,
  ...
  return linear_mxfp4_sm100_no_quantization_kernel(qpack[0], qpack[1], weight,
                                                   weight_sf, residual, use_2sm);
}
