...
#if MPK_TARGET_CC >= 90 || (defined(__CUDA_ARCH__) && __CUDA_ARCH__ >= 900)
constexpr int MAX_DYNAMIC_SHARED_MEMORY_SIZE =
    227 * 1024 - WORKER_RESERVED_STATIC_SHARED_MEMORY_SIZE;
#elif MPK_TARGET_CC >= 86 || (defined(__CUDA_ARCH__) && __CUDA_ARCH__ >= 860)
constexpr int MAX_DYNAMIC_SHARED_MEMORY_SIZE =
    99 * 1024 - WORKER_RESERVED_STATIC_SHARED_MEMORY_SIZE;
#elif MPK_TARGET_CC >= 80 || (defined(__CUDA_ARCH__) && __CUDA_ARCH__ >= 800)
constexpr int MAX_DYNAMIC_SHARED_MEMORY_SIZE =
