...
// ============================================================================
// SM100 FP4 linear-kernel primitives
//
...
// {NVFP4, MXFP4}). These are cuda-only (no CUTLASS), so they live here in
// sm100_ptx.cuh rather than in sm100_utils.cuh.
//
// Naming convention:
...
//
// Descriptor encoding and the CTA-scope mbarrier init/wait reuse the original
// sm100_ptx helpers: desc_enc, mbar_init, mbar_wait.
// ----------------------------------------------------------------------------
