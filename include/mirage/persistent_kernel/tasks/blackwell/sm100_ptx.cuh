...
// SM100 (Blackwell) PTX helpers: tcgen05 MMA, TMA mbarrier, TMEM, warp election.
// Shared by any SM100 kernel using tensor cores (MLA decode, MTP, future kernels).
#pragma once
...
__device__ __forceinline__ void tcgen05_mma(int taddr, uint64_t a_desc, uint64_t b_desc,
