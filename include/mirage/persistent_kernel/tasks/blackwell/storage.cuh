...
// Scaled piped task storage with a dedicated raw epilogue staging buffer.
// This keeps the producer/MMA buffers unchanged while giving the epilogue
// a single unambiguous physical layout for subtile TMA stores.
template <class TypeA,
          class TypeB,
          class TypeC,
          class TypeSF,
