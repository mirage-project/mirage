...
// MXFP4 version: uses float_ue8m0_t as scale factor (8-bit exponent, 0-bit mantissa)
...
linear_mxfp4_1d2d_sm100_task_impl(const TMA_A &tma_a,
                                  const TMA_B &tma_b,
    ...
    using SF_type = cutlass::float_ue8m0_t;  // MXFP4 uses 8-bit exponent scale factor
    using C_type  = float;
