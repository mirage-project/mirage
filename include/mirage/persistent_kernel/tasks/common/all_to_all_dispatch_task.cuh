...
// NVSHMEM-based AllToAll dispatch kernel.
//
...
//             After all puts, this PE writes sync_sigs[rank] = 1 on every PE
//             via nvshmemx_signal_op so the combine phase can signal-wait.
//
