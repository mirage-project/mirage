...
TaskGraphResult print_task_graph(
  ...
  task_type_to_name[TASK_LINEAR_FP8_MPK_SM100] = "TASK_LINEAR_FP8_MPK_SM100";
  task_type_to_name[TASK_LINEAR_FP8_WITH_RESIDUAL_MPK_SM100] =
      "TASK_LINEAR_FP8_WITH_RESIDUAL_MPK_SM100";
