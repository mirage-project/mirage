 ...
 */
 ...
 __device__ __forceinline__ void attention_qkvproj_kernel_impl(bfloat16_t* __restrict__ dtensor10000007_ptr, bfloat16_t const* __restrict__ dtensor10000004_ptr, bfloat16_t const* __restrict__ dtensor10000006_ptr, int4 offset_in0,
   int4 offset_in1,
   int4 offset_out0,
   int forloop_range);
 
 #define ATTENTIONPART1_KERNEL(I0, I0D, I1, I1D, O0, O0D) \
   attention_qkvproj_kernel_impl<I0, I0D, I1, I1D, O0, O0D>(dtensor10000005_ptr, dtensor10000003_ptr, dtensor10000004_ptr, tensor_offsets[0], tensor_offsets[1], tensor_offsets[2], forloop_range)
 
 __device__ __forceinline__ void AttentionPart1Kernel::execute(TensorDesc* inputs, TensorDesc* outputs, int4 *tensor_offsets, int forloop_range) 
 { 
