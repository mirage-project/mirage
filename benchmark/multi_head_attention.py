...
if __name__ == "__main__":
    ...
    Q = graph.new_input(dims=(32 * batch_size, 16, 64), dtype=mi.float16)
    K = graph.new_input(dims=(32 * batch_size, 64, 4096), dtype=mi.float16)
    V = graph.new_input(dims=(32 * batch_size, 4096, 64), dtype=mi.float16)
    A = graph.matmul(Q, K)
    E = graph.exp(A)
