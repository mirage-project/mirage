...
class KNGraph:
    ...
    def superoptimize(
        ...
        fmaps: list = None,
        franges: list = None,
        max_num_threadblock_graph_op: int = -1,
        max_num_kernel_graph_op: int = -1,
        num_search_thread: int = -1,
        verbose: bool = False,
        config: str = None,
        backend: str = "cuda",
        warmup_iters: int = 16,
        ...
        cygraphs = search(
            ...
            fmaps=fmaps,
            franges=franges,
            max_num_threadblock_graph_op=max_num_threadblock_graph_op,
            max_num_kernel_graph_op=max_num_kernel_graph_op,
            num_search_thread=num_search_thread,
